...
def show_entry_fields():
   ...
   worksheet.write(str('C' + str(2)), str(mo))
   worksheet.write(str('D' + str(2)), str(rn))
   worksheet.write(str('E' + str(2)), str(em))
   workbook.close()
...
lbl = Label(tab1, text="USER  REGISTRATION  DETAILS",font=("Arial Bold", 30),foreground =("red"),background  =("white"))
